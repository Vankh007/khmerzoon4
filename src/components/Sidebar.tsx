...
const Sidebar = ({
  ...
  return <>
      <aside className={cn('w-56 bg-background/50 border-r border-border/20', isSlideIn && 'bg-background/50')}>
        <ScrollArea className="max-h-screen">
          <div className="pb-2">
            {/* Header with Menu Toggle, Logo and Site Name */}
            <div className="flex items-center gap-2 px-2 py-3 border-b border-border/20">
              <Button
                variant="ghost"
                size="icon"
                onClick={onToggle}
