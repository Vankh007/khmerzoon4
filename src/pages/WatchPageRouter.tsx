 ...
 * Routes to WatchPage (with NativeVideoPlayer) on desktop and iPad (all orientations)
 * iPad always uses desktop layout for fullscreen compatibility
 */
const WatchPageRouter = () => {
  ...
  // iPad always uses desktop layout (both portrait and landscape)
  if (isIPad) {
    return <WatchPage />;
  }
  ...
  // Desktop uses full-featured watch page
  return <WatchPage />;
};
