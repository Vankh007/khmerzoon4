...
const EmbedSeries = () => {
  ...
  // Filter episodes by selected season and map to NativeVideoPlayer Episode format
  const filteredEpisodes = (selectedSeasonId 
    ...
    duration: ep.duration ? parseInt(ep.duration, 10) || undefined : undefined,
    version: ep.version,
      ...
      <AspectRatio ratio={16 / 9} className="bg-black h-full">
        ...
        >
          <NativeVideoPlayer 
            ...
            currentSeasonId={selectedSeasonId || undefined}
