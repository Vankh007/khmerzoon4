          ...
          >
            ...
            <div className="space-y-3">
              <div className="relative">
                <Mail className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-primary z-10" />
                <Input
                  type="email"
                  placeholder="Email"
                  value={email}
                  ...
                  required
                  className="pl-10 h-11 bg-transparent border-2 border-primary rounded-lg placeholder:text-primary/60 text-primary"
                />
              </div>
              <div className="relative">
            ...
            <div className="space-y-3">
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={(e) => setEmail(e.target.value)}
                  required
                  className="pl-10 h-12 bg-transparent border-2 border-primary rounded-lg placeholder:text-primary/60 text-primary"
                />
              </div>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-primary z-10" />
